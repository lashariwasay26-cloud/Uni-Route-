...
print("Writing Part 2 and Part 3 files...")

p2_code = '''import { WritingExerciseBlock } from './satWritingTypes';
...
export const EXERCISE_BLOCK_6: WritingExerciseBlock = {
  ...
  questions: [
    ...
    },
    {
      ...
      prompt: 'The paleoclimatology team identified a abrupt spike in atmospheric carbon isotope ratios in the sediment layer. ___, they concluded that a major volcanic episode had occurred during that geological epoch.',
      options: [
        'Consequently',
        'Nevertheless',
        'By contrast',
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: {
        coreReasoning: '"In short" serves as a summarizing transition, synthesizing the four listed positive trial outcomes into a overarching conclusion regarding global distribution readiness.',
...
with open('/src/data/writing/satWritingChapter7QuestionsPart2.ts', 'w') as f:
    f.write(p2_code)
