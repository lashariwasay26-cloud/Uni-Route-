...
export const EXERCISE_BLOCK_8: WritingExerciseBlock = {
  ...
  questions: [
    ...
    },
    {
      ...
      prompt: 'The conference delegation included representative delegates from three institutions: **Dr. Aris Thorne, a biochemist from Oxford; Dr. Maya Lin, a geneticist from Stanford; and Dr. Isaac Vance, an oceanographer from Woods Hole.** Which choice correctly separates complex list items containing internal commas?',
      options: [
...
export const EXERCISE_BLOCK_9: WritingExerciseBlock = {
  ...
  questions: [
    ...
    },
    {
      ...
      prompt: 'A study observed a positive statistical correlation between urban park acreage and self-reported resident happiness scores, but sociologists did not control for resident income or age. Which statement accurately reports the finding?',
      options: [
    ...
    },
    {
      ...
      prompt: 'In a medical trial, cardiologists measured baseline cholesterol before administering the compound and observed a 14% drop after six weeks. Which choice respects chronological sequence integrity?',
      options: [
...
export const EXERCISE_BLOCK_10: WritingExerciseBlock = {
  ...
  questions: [
    ...
    },
    {
      ...
      prompt: 'A marine conservation biologist preparing a coastal ecosystem report compiled the following carbon storage data:\n• Mangrove forests sequester carbon at rates up to 10 times higher per hectare than terrestrial tropical rainforests.\n• Mangrove sediment soils store carbon in anoxic conditions for thousands of years ("blue carbon").\n• Global mangrove coverage declined by 3.5% between 1996 and 2020 due to coastal aquaculture development.\n\nThe researcher wants to emphasize mangroves\' climate mitigation value alongside their conservation vulnerability for an environmental policy briefing. Which choice best accomplishes this goal?',
      options: [
    ...
    },
    {
      ...
      prompt: 'A coastal ecologist analyzing empirical data from barrier island restoration projects documented the following findings:\n• Coastal wetland restoration projects in Louisiana recorded a 25% decrease in shoreline erosion rate.\n• Restored sites also received supplemental stone breakwater installation.\n• Ecologists could not isolate how much erosion reduction was caused by wetland vegetation versus stone breakwaters.\n\nThe ecologist wants to summarize the study finding while highlighting the limitation caused by the confounding variable. Which choice best accomplishes this goal?',
      options: [
        'Although restored wetlands experienced a 25% decrease in shoreline erosion, the concurrent installation of stone breakwaters prevents ecologists from isolating the specific contribution of vegetation.',
      ...
      explanation: {
        ...
        distractorAnalysis: [
          { optionIndex: 0, optionLabel: 'A', optionText: 'Although restored wetlands experienced a 25% decrease in shoreline erosion, the concurrent installation of stone breakwaters prevents ecologists from isolating the specific contribution of vegetation.', whyWrong: 'Correct. Preserves finding and confounding limitation.' },
